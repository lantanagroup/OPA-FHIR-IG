...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://oash.org/fhir/us/opa/StructureDefinition/client-asserted-sex']) &lt;= 1">extension with URL = 'http://oash.org/fhir/us/opa/StructureDefinition/client-asserted-sex': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://oash.org/fhir/us/opa/StructureDefinition/english-proficiency']) &lt;= 1">extension with URL = 'http://oash.org/fhir/us/opa/StructureDefinition/english-proficiency': maximum cardinality of 'extension' is 1</sch:assert>
